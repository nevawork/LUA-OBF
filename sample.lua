...
return (function(_ENV)
 ...
 local EYDd6aR=_ENV.unpack or (table and table.unpack)
 local function Tsne6xDYC2(t,i,j)
  if i>j then return end
  if EYDd6aR and j-i>15 then return EYDd6aR(t,i,j) end
  return t[i],Tsne6xDYC2(t,i+1,j)
 end
 local nhF8LbFqS=_ENV.string.char
 local ZfSbNtvA7=_ENV.table.concat
 ...
 do
  ...
  local lICscIFlu={} local G4_nBIbG={}
 ...
 local function HufYjZ(l1,AVecaN,PUHWlcjEHw1,Xk8gaK3RyL,dzGyVOSwMGR,tln6dp)
  local lICscIFlu,G4_nBIbG,aSxOxR=l1.P,l1.WM,l1.WMI
 ...
 return HufYjZ(HufYjZ_decode(),1,_ENV,{},QfABOznDnM8,nil)
end)({})